...
set_property PACKAGE_PIN W3 [get_ports {T[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {T[0]}]
set_property PACKAGE_PIN U3 [get_ports {T[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {T[1]}]
set_property PACKAGE_PIN P3 [get_ports {T[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {T[2]}]
set_property PACKAGE_PIN N3 [get_ports {T[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {T[3]}]
set_property PACKAGE_PIN P1 [get_ports {T[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {T[4]}]
set_property PACKAGE_PIN L1 [get_ports {T[5]}]					
...
set_property PACKAGE_PIN U17 [get_ports pb]						
